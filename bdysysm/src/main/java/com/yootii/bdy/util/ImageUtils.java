...
//		return encoder.encode(outputStream.toByteArray());// 返回Base64编码过的字节数组字符串
	...
	// 对图片进行缩小
	public static boolean cutImage(String imagePath, String destFile) {
...
//							+ formatName);
				...
				if (size1>1){
					...
					if (size2>1){	
						...
						/* 调整后的图片的宽度和高度 */  
						toWidth = (int)tempWidth;						
						toHeight = (int)tempheight;
					}
				}				
...
//				boolean result=writeHighQuality(imResult,destFile);
				
				boolean result=saveImage(imResult,destFile);
...
//     }  
	...
	/*
	public static boolean savePic(BufferedImage bufferedImage, int w, int h, String destFile) { 
...
//        BufferedImage bi = new BufferedImage(w, h, BufferedImage.TYPE_3BYTE_BGR);
        ...
        BufferedImage bi = new BufferedImage(miniw, miniy, BufferedImage.TYPE_3BYTE_BGR);
...
//            g.drawImage(bufferedImage, 0, 0, null);
        	g.drawImage(bufferedImage, 0, 0, miniw, miniy, null);    
//            g.drawImage(bufferedImage, 0, 0, miniw, miniy, 0, 0, w, h, null);                      
	...
	*/
	...
	public static void main(String[] args) {
		// 测试从图片文件转换为Base64编码
		String filePath="C:/test/fuye1.jpg";
		String destFile="C:/test/fuye2.jpg";
		cutImage(filePath, destFile);
		String base64String= encodeImgageToBase64(destFile);
...
//		String base64String="";
		// 测试从Base64编码转换为图片文件  
	decodeBase64ToImage(base64String,"C:/test/fytest23.jpg");
